...
class LoginFragment : BaseFragment() {
    ...
    private fun processLoginState(renderState: LoginState) {
        ...
        when (renderState) {
            LoginState.SUCCESS_LOGIN -> rootActivity.navigateTo(ProfileFragment.toString(), null)
            LoginState.SUCCESS_REGISTER -> rootActivity.navigateTo(ProfileFragment.toString(), null)
